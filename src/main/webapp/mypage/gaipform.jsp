...
<body>
<h4 style="width: 500px; margin: 0 auto; margin-top: 50px; text-align: center;">회원가입</h4>
<div  style="width: 500px; margin: 0 auto; margin-top: 50px; border: 1px solid #ccc; border-radius: 10px;">
