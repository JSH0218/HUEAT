    ...
    <form id="frm">
     ...
     <tr>
     	<td style="background-color: #ebeae7; font-size: 1.3em; text-align: center; height: 80px; vertical-align: middle;">
     			<span style="float: left; font-size: 1.3em;"><%=util.SecurityUtil.escapeHtml(dto.getN_subject()) %></span>
          <span class="day"><%=util.SecurityUtil.escapeHtml(name) %> | <%=sdf.format(dto.getN_writeday()) %></span>
      ...
      <tr height="300" align="center">
        <td>
           <img alt="" src="fileview?type=notice&name=<%=util.SecurityUtil.urlEncode(dto.getN_image())%>" style="height: 200px;"><br><br><br>
           <%=util.SecurityUtil.nl2brEscaped(dto.getN_content()) %><br><br>
        </td>
     </tr>
